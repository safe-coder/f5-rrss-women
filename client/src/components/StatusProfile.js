        ...
        <div className  =  {status.edit ? "editstatus" : "status"}   >
            <form onSubmit={handleSubmit}>
                ...
                <div className="status-middle">
                    <textarea type="text" placeholder="¡Compártelo con nosotras!" 
               ...
               <div className="status-imagesdiv">
                {
                    images && images.map((image,index)=> (
                      ...
                      <div className="status-middleimagecontainer" >
                        ...
                        <span className="status-middleimagedelete" onClick={() => deleteimage(index)}> <CancelRoundedIcon fontSize="large"/></span>
                ...
                <div className="status-footer">
                   ...
                   {/* <PhotoIcon onClick={handleStream}/> */}
